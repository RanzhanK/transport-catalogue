...
namespace transport_catalogue {
    namespace detail {
        namespace router {
            ...
            TransportRouter::get_edge(EdgeId id) const { return edge_id_to_edge_.at(id); }
            ...
            TransportRouter::get_stop_to_vertex() const { return stop_to_router_; }

            const std::unordered_map<EdgeId, std::variant<StopEdge, BusEdge>> &
            TransportRouter::get_edge_id_to_edge() const { return edge_id_to_edge_; }
